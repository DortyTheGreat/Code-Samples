    ...
    const std::vector<std::unique_ptr<Object>> &objects)
{
    ...
    std::ofstream ofs("frames/out" + std::to_string(options.frame) + ".ppm", std::ios::out | std::ios::binary);
...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < 100; ++i) {
        ...
        options.fov = 51.52;
        options.frame = i;
        options.cameraToWorld = Matrix44f(0.945519, 0, -0.325569, 0, -0.179534, 0.834209, -0.521403, 0, 0.271593, 0.551447, 0.78876, 0, 4.208271, 8.374532, 17.932925+(float)i / 50.0f, 1);
